...
# static fields
.field private static final QUOTED_STRING_DELIMITERS:Lcd/i;

.field private static final TOKEN_DELIMITERS:Lcd/i;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:Lcd/i;
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lcd/i;
...
.method private static parseChallengeHeader(Ljava/util/List;Lcd/f;)V
    .locals 8
    ...
    .line 1
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->skipWhitespaceAndCommas(Lcd/f;)Z

    .line 2
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->readToken(Lcd/f;)Ljava/lang/String;
    ...
    .line 7
    invoke-static {p1, v4}, Lokhttp3/internal/http/HttpHeaders;->skipAll(Lcd/f;B)I
    ...
    invoke-virtual {p1, v6, v7}, Lcd/f;->G(J)B
    ...
    .line 21
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(Lcd/f;)Ljava/lang/String;
...
.method public static parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v2, v3}, Lcd/f;->c1(Ljava/lang/String;)Lcd/f;

    move-result-object v2

    .line 5
    invoke-static {v0, v2}, Lokhttp3/internal/http/HttpHeaders;->parseChallengeHeader(Ljava/util/List;Lcd/f;)V
...
.method private static readQuotedString(Lcd/f;)Ljava/lang/String;
    .locals 12
    ...
    .line 3
    :goto_0
    sget-object v2, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:Lcd/i;

    invoke-virtual {p0, v2}, Lcd/f;->q0(Lcd/i;)J
    ...
    .line 5
    invoke-virtual {v0, p0, v2, v3}, Lcd/f;->write(Lcd/f;J)V
    ...
    .line 11
    invoke-virtual {v0, p0, v7, v8}, Lcd/f;->write(Lcd/f;J)V
...
.method private static readToken(Lcd/f;)Ljava/lang/String;
    .locals 5

    .line 1
    :try_start_0
    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lcd/i;

    invoke-virtual {p0, v0}, Lcd/f;->q0(Lcd/i;)J
...
.method private static skipAll(Lcd/f;B)I
    .locals 3
    ...
    invoke-virtual {p0, v1, v2}, Lcd/f;->G(J)B
...
.method private static skipWhitespaceAndCommas(Lcd/f;)Z
    .locals 3
