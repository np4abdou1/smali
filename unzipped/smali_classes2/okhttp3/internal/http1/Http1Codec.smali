...
# direct methods
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lcd/h;Lcd/g;)V
    .locals 2
    ...
    .line 6
    iput-object p3, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lcd/h;

    .line 7
    iput-object p4, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcd/g;
...
.method private readHeaderLine()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lcd/h;

    iget-wide v1, p0, Lokhttp3/internal/http1/Http1Codec;->headerLimit:J

    invoke-interface {v0, v1, v2}, Lcd/h;->d0(J)Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)Lcd/a0;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSink()Lcd/a0;
    ...
    .line 3
    invoke-virtual {p0, p2, p3}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSink(J)Lcd/a0;
...
.method public detachTimeout(Lcd/l;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Lcd/l;->a()Lcd/d0;

    move-result-object v0

    .line 2
    sget-object v1, Lcd/d0;->NONE:Lcd/d0;

    invoke-virtual {p1, v1}, Lcd/l;->b(Lcd/d0;)Lcd/l;
...
.method public finishRequest()V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcd/g;

    invoke-interface {v0}, Lcd/g;->flush()V
...
.method public newChunkedSink()Lcd/a0;
    .locals 3
...
.method public newChunkedSource(Lokhttp3/HttpUrl;)Lcd/c0;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newFixedLengthSink(J)Lcd/a0;
    .locals 2
...
.method public newFixedLengthSource(J)Lcd/c0;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newUnknownLengthSource()Lcd/c0;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    .line 4
    invoke-virtual {p0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lcd/c0;
    ...
    invoke-direct {v3, v0, v1, v2, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcd/h;)V
    ...
    invoke-virtual {p0, p1}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSource(Lokhttp3/HttpUrl;)Lcd/c0;
    ...
    invoke-direct {v1, v0, v2, v3, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcd/h;)V
    ...
    .line 10
    invoke-virtual {p0, v4, v5}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lcd/c0;
    ...
    invoke-direct {v1, v0, v4, v5, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcd/h;)V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newUnknownLengthSource()Lcd/c0;
    ...
    invoke-direct {p1, v0, v2, v3, v1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcd/h;)V
...
.method public writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    .line 4
    iget-object v2, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcd/g;

    invoke-virtual {p1, p2}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    .line 7
    invoke-interface {v2, v0}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    .line 8
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcd/g;

    invoke-interface {p1, v0}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
