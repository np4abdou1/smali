...
.method public constructor <init>(Lcd/g;Z)V
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lcd/g;
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lcd/f;

    .line 5
    new-instance p2, Lokhttp3/internal/http2/Hpack$Writer;

    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(Lcd/f;)V
...
.method private writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lcd/g;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lcd/f;

    invoke-interface {v0, v1, v4, v5}, Lcd/a0;->write(Lcd/f;J)V
...
.method private static writeMedium(Lcd/g;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-interface {p0, v0}, Lcd/g;->O(I)Lcd/g;
    ...
    .line 3
    invoke-interface {p0, p1}, Lcd/g;->O(I)Lcd/g;
...
.method public declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lcd/g;
...
.method public declared-synchronized connectionPreface()V
    ...
    .line 4
    sget-object v4, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lcd/i;

    invoke-virtual {v4}, Lcd/i;->m()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lcd/i;

    invoke-virtual {v1}, Lcd/i;->B()[B

    move-result-object v1

    invoke-interface {v0, v1}, Lcd/g;->write([B)Lcd/g;
...
.method public declared-synchronized data(ZILcd/f;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IBLcd/f;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public dataFrame(IBLcd/f;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, Lcd/a0;->write(Lcd/f;J)V
...
.method public frameHeader(IIBB)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/http2/Http2Writer;->writeMedium(Lcd/g;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lcd/g;
    ...
    invoke-interface {p2, p1}, Lcd/g;->D(I)Lcd/g;
...
.method public declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lcd/g;->D(I)Lcd/g;
    ...
    invoke-interface {p1, p2}, Lcd/g;->D(I)Lcd/g;
    ...
    invoke-interface {p1, p3}, Lcd/g;->write([B)Lcd/g;
...
.method public headers(ZILjava/util/List;)V
    ...
    .line 7
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lcd/f;

    invoke-virtual {p3}, Lcd/f;->N0()J
    ...
    invoke-interface {p1, p3, v2, v3}, Lcd/a0;->write(Lcd/f;J)V
...
.method public declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lcd/g;->D(I)Lcd/g;
...
.method public declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 6
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lcd/g;

    const v2, 0x7fffffff

    and-int/2addr p2, v2

    invoke-interface {p3, p2}, Lcd/g;->D(I)Lcd/g;
    ...
    invoke-interface {p2, p3, v4, v5}, Lcd/a0;->write(Lcd/f;J)V
...
.method public declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lcd/g;

    invoke-interface {v3, v0}, Lcd/g;->w(I)Lcd/g;
    ...
    invoke-interface {v0, v3}, Lcd/g;->D(I)Lcd/g;
