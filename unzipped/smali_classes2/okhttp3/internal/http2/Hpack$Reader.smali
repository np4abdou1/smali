...
# direct methods
.method public constructor <init>(IILcd/c0;)V
    .locals 1
    ...
    .line 10
    invoke-static {p3}, Lcd/p;->d(Lcd/c0;)Lcd/h;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lcd/h;

    return-void
.end method

.method public constructor <init>(ILcd/c0;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p1, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(IILcd/c0;)V
...
.method private getName(I)Lcd/i;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Lcd/i;
...
.method private readByte()I
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lcd/h;
...
.method private readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lcd/i;

    move-result-object p1

    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lcd/i;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lcd/i;Lcd/i;)V
...
.method private readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-static {v0}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lcd/i;)Lcd/i;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lcd/i;Lcd/i;)V
...
.method private readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lcd/i;Lcd/i;)V
...
.method private readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lcd/i;Lcd/i;)V
...
.method public readByteString()Lcd/i;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lcd/h;

    int-to-long v3, v0

    invoke-interface {v2, v3, v4}, Lcd/h;->P(J)[B
    ...
    invoke-static {v0}, Lcd/i;->q([B)Lcd/i;
    ...
    .line 4
    :cond_1
    iget-object v1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lcd/h;

    int-to-long v2, v0

    invoke-interface {v1, v2, v3}, Lcd/h;->r(J)Lcd/i;
