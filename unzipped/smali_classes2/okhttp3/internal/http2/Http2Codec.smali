...
.method public static http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_METHOD:Lcd/i;

    invoke-virtual {p0}, Lokhttp3/Request;->method()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Header;-><init>(Lcd/i;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_PATH:Lcd/i;
    ...
    sget-object v4, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lcd/i;

    invoke-direct {v3, v4, v2}, Lokhttp3/internal/http2/Header;-><init>(Lcd/i;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_SCHEME:Lcd/i;
    ...
    invoke-direct {v2, v3, p0}, Lokhttp3/internal/http2/Header;-><init>(Lcd/i;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lcd/i;->g(Ljava/lang/String;)Lcd/i;
    ...
    invoke-direct {v4, v3, v5}, Lokhttp3/internal/http2/Header;-><init>(Lcd/i;Ljava/lang/String;)V
...
.method public createRequestBody(Lokhttp3/Request;J)Lcd/a0;
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->getSink()Lcd/a0;
...
.method public finishRequest()V
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->getSink()Lcd/a0;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v3}, Lokhttp3/internal/http2/Http2Stream;->getSource()Lcd/c0;

    move-result-object v3

    invoke-direct {p1, p0, v3}, Lokhttp3/internal/http2/Http2Codec$StreamFinishingSource;-><init>(Lokhttp3/internal/http2/Http2Codec;Lcd/c0;)V
...
.method public writeRequestHeaders(Lokhttp3/Request;)V
    ...
    .line 5
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->readTimeout()Lcd/d0;
    ...
    invoke-virtual {p1, v0, v1, v2}, Lcd/d0;->timeout(JLjava/util/concurrent/TimeUnit;)Lcd/d0;

    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->writeTimeout()Lcd/d0;
