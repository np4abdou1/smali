...
# direct methods
.method public constructor <init>(IZLcd/f;)V
    .locals 1
    ...
    .line 11
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lcd/f;
...
.method public constructor <init>(Lcd/f;)V
    ...
    .line 1
    invoke-direct {p0, v0, v1, p1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLcd/f;)V
...
.method public writeByteString(Lcd/i;)V
    .locals 3
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lcd/i;)I
    ...
    invoke-virtual {v2, p1, v0}, Lokhttp3/internal/http2/Huffman;->encode(Lcd/i;Lcd/g;)V
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lcd/f;
...
.method public writeHeaders(Ljava/util/List;)V
    ...
    .line 9
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Lcd/i;

    invoke-virtual {v4}, Lcd/i;->A()Lcd/i;

    move-result-object v4

    .line 10
    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Lcd/i;
    ...
    iget-object v10, v10, Lokhttp3/internal/http2/Header;->value:Lcd/i;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Header;->value:Lcd/i;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:Lcd/i;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:Lcd/i;
    ...
    .line 21
    iget-object v7, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lcd/f;

    invoke-virtual {v7, v6}, Lcd/f;->U0(I)Lcd/f;

    .line 22
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lcd/i;)V

    .line 23
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lcd/i;)V
    ...
    .line 25
    :cond_9
    sget-object v7, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Lcd/i;

    invoke-virtual {v4, v7}, Lcd/i;->z(Lcd/i;)Z

    move-result v7

    if-eqz v7, :cond_a

    sget-object v7, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lcd/i;

    invoke-virtual {v7, v4}, Lcd/i;->equals(Ljava/lang/Object;)Z
...
.method public writeInt(III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lcd/f;

    or-int/2addr p1, p3

    invoke-virtual {p2, p1}, Lcd/f;->U0(I)Lcd/f;
    ...
    invoke-virtual {v0, p3}, Lcd/f;->U0(I)Lcd/f;
    ...
    invoke-virtual {v0, p2}, Lcd/f;->U0(I)Lcd/f;
