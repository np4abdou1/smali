...
.method public encode(Lcd/i;Lcd/g;)V
    .locals 7
    ...
    .line 2
    invoke-virtual {p1, v0}, Lcd/i;->h(I)B
    ...
    .line 5
    invoke-interface {p2, v5}, Lcd/g;->O(I)Lcd/g;
    ...
    .line 6
    invoke-interface {p2, p1}, Lcd/g;->O(I)Lcd/g;

    :cond_2
    return-void
.end method

.method public encodedLength(Lcd/i;)I
    .locals 5
