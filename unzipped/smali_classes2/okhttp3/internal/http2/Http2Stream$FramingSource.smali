...
.field private final readBuffer:Lcd/f;

.field private final receiveBuffer:Lcd/f;
...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Stream;J)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lcd/f;
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lcd/f;
...
.method public close()V
    ...
    .line 3
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lcd/f;
    ...
    .line 4
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lcd/f;

    invoke-virtual {v3}, Lcd/f;->b()V
...
.method public read(Lcd/f;J)J
    ...
    .line 8
    :cond_1
    iget-object v0, v1, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lcd/f;
    ...
    invoke-virtual {v0, v13, v11, v12}, Lcd/f;->read(Lcd/f;J)J
...
.method public receive(Lcd/h;J)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 3
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lcd/f;
    ...
    .line 8
    :cond_3
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lcd/f;

    invoke-interface {p1, v2, p2, p3}, Lcd/c0;->read(Lcd/f;J)J
    ...
    .line 11
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lcd/f;
    ...
    .line 12
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lcd/f;

    invoke-virtual {v5}, Lcd/f;->b()V
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lcd/f;

    invoke-virtual {v3, v4}, Lcd/f;->Z(Lcd/c0;)J
