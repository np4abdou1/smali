...
.field private final source:Lcd/h;
...
.method public constructor <init>(Lcd/h;Z)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcd/h;
    ...
    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lcd/h;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILcd/c0;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcd/h;
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcd/h;

    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILcd/h;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcd/h;

    int-to-long p2, v0

    invoke-interface {p1, p2, p3}, Lcd/h;->a(J)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcd/h;

    invoke-interface {p4}, Lcd/h;->readInt()I

    move-result p4

    .line 2
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcd/h;

    invoke-interface {v2}, Lcd/h;->readInt()I
    ...
    invoke-interface {p3, v1, v2}, Lcd/h;->r(J)Lcd/i;

    move-result-object p3

    .line 6
    :cond_0
    invoke-interface {p1, p4, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lcd/i;)V
...
.method public static readMedium(Lcd/h;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcd/h;

    invoke-interface {p2}, Lcd/h;->readInt()I
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    invoke-interface {v0}, Lcd/h;->readInt()I
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcd/h;

    invoke-interface {v3}, Lcd/h;->readByte()B
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcd/h;

    invoke-interface {v1}, Lcd/h;->readInt()I
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v2}, Lcd/h;->readShort()S
    ...
    invoke-interface {v3}, Lcd/h;->readInt()I
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, Lcd/h;->r0(J)V
    :try_end_0
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Lcd/h;)I
    ...
    invoke-interface {p1}, Lcd/h;->readByte()B
    ...
    invoke-interface {p1, v0, v1}, Lcd/h;->a(J)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lcd/i;
    ...
    invoke-interface {p1, v3, v4}, Lcd/h;->r(J)Lcd/i;
    ...
    .line 7
    invoke-virtual {p1}, Lcd/i;->C()Ljava/lang/String;
