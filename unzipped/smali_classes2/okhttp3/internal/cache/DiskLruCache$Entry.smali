...
.method public snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lcd/c0;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lcd/c0;[J)V
    :try_end_0
...
.method public writeLengths(Lcd/g;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    invoke-interface {p1, v5}, Lcd/g;->O(I)Lcd/g;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lcd/g;->u0(J)Lcd/g;
