...
.method public static isPlaintext(Lcd/f;)Z
    .locals 8
    ...
    .line 3
    invoke-virtual/range {v1 .. v6}, Lcd/f;->x(Lcd/f;JJ)Lcd/f;
...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    .line 27
    invoke-virtual {v7, v5}, Lokhttp3/RequestBody;->writeTo(Lcd/g;)V
    ...
    .line 32
    invoke-static {v5}, Lokhttp3/logging/HttpLoggingInterceptor;->isPlaintext(Lcd/f;)Z
    ...
    invoke-virtual {v5, v10}, Lcd/f;->D0(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .line 59
    :cond_16
    invoke-virtual {v3}, Lokhttp3/ResponseBody;->source()Lcd/h;
    ...
    .line 60
    invoke-interface {v4, v5, v6}, Lcd/h;->y(J)Z

    .line 61
    invoke-interface {v4}, Lcd/h;->c()Lcd/f;
    ...
    .line 64
    :try_start_1
    new-instance v6, Lcd/m;

    invoke-virtual {v4}, Lcd/f;->d()Lcd/f;

    move-result-object v4

    invoke-direct {v6, v4}, Lcd/m;-><init>(Lcd/c0;)V
    :try_end_1
    ...
    invoke-direct {v4}, Lcd/f;-><init>()V

    .line 66
    invoke-virtual {v4, v6}, Lcd/f;->Z(Lcd/c0;)J
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    .line 67
    invoke-virtual {v6}, Lcd/m;->close()V
    ...
    invoke-virtual {v5}, Lcd/m;->close()V
    ...
    .line 71
    :cond_19
    invoke-static {v4}, Lokhttp3/logging/HttpLoggingInterceptor;->isPlaintext(Lcd/f;)Z
    ...
    invoke-virtual {v6, v2}, Lcd/f;->D0(Ljava/nio/charset/Charset;)Ljava/lang/String;
