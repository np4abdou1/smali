...
.method public static maybeAddTransition(Lx1/s;Lx1/o;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 1
    invoke-virtual {p0, p1}, Lx1/s;->f(Lx1/o;)Lx1/s;

    :cond_0
    return-void
.end method

.method public static maybeApplyThemeDuration(Lx1/o;Landroid/content/Context;I)Z
    .locals 5
    ...
    .line 3
    invoke-virtual {p0, p1, p2}, Lx1/o;->setDuration(J)Lx1/o;
...
.method public static maybeApplyThemeInterpolator(Lx1/o;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    .locals 1
...
.method public static maybeApplyThemePath(Lx1/o;Landroid/content/Context;I)Z
    .locals 0

    if-eqz p2, :cond_0

    .line 1
    invoke-static {p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->resolveThemePath(Landroid/content/Context;I)Lx1/g;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lx1/o;->setPathMotion(Lx1/g;)V
...
.method public static maybeRemoveTransition(Lx1/s;Lx1/o;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 1
    invoke-virtual {p0, p1}, Lx1/s;->o(Lx1/o;)Lx1/s;
...
.method public static resolveThemeInterpolator(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    ...
    .line 13
    invoke-static {p2, v0, v1, p0}, Ls0/b;->a(FFFF)Landroid/view/animation/Interpolator;
    ...
    invoke-static {p0}, Ls0/b;->b(Landroid/graphics/Path;)Landroid/view/animation/Interpolator;
...
.method public static resolveThemePath(Landroid/content/Context;I)Lx1/g;
    .locals 3
    ...
    invoke-direct {p1, p0}, Lx1/i;-><init>(Landroid/graphics/Path;)V
