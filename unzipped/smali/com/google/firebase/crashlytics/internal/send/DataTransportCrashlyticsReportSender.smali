...
.field private static final DEFAULT_TRANSFORM:Lh9/e;
...
# instance fields
.field private final transport:Lh9/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh9/f<",
            "Lcom/google/firebase/crashlytics/internal/model/CrashlyticsReport;",
...
.field private final transportTransform:Lh9/e;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh9/e<",
            "Lcom/google/firebase/crashlytics/internal/model/CrashlyticsReport;",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->DEFAULT_TRANSFORM:Lh9/e;

    return-void
.end method

.method public constructor <init>(Lh9/f;Lh9/e;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->transport:Lh9/f;

    .line 3
    iput-object p2, p0, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->transportTransform:Lh9/e;
...
.method public static create(Landroid/content/Context;)Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;
    ...
    .line 1
    invoke-static {p0}, Lk9/r;->f(Landroid/content/Context;)V

    .line 2
    invoke-static {}, Lk9/r;->c()Lk9/r;
    ...
    invoke-direct {v0, v1, v2}, Li9/a;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    .line 3
    invoke-virtual {p0, v0}, Lk9/r;->g(Lk9/e;)Lh9/g;
    ...
    .line 4
    invoke-static {v1}, Lh9/b;->b(Ljava/lang/String;)Lh9/b;

    move-result-object v1

    sget-object v2, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->DEFAULT_TRANSFORM:Lh9/e;

    const-string v3, "FIREBASE_CRASHLYTICS_REPORT"

    .line 5
    invoke-interface {p0, v3, v0, v1, v2}, Lh9/g;->a(Ljava/lang/String;Ljava/lang/Class;Lh9/b;Lh9/e;)Lh9/f;
    ...
    invoke-direct {v0, p0, v2}, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;-><init>(Lh9/f;Lh9/e;)V
...
.method public sendReport(Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 3
    iget-object v2, p0, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->transport:Lh9/f;

    .line 4
    invoke-static {v0}, Lh9/c;->e(Ljava/lang/Object;)Lh9/c;

    move-result-object v0

    new-instance v3, Lda/b;

    invoke-direct {v3, v1, p1}, Lda/b;-><init>(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;)V

    .line 5
    invoke-interface {v2, v0, v3}, Lh9/f;->b(Lh9/c;Lh9/h;)V
