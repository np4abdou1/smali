...
# instance fields
.field public final retrofit:Lrd/r;
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lcom/twitter/sdk/android/core/internal/TwitterApi;)V
    .locals 1
    ...
    .line 11
    invoke-direct {p0, p1, p2}, Lcom/twitter/sdk/android/core/TwitterApiClient;->buildRetrofit(Lokhttp3/OkHttpClient;Lcom/twitter/sdk/android/core/internal/TwitterApi;)Lrd/r;

    move-result-object p1

    iput-object p1, p0, Lcom/twitter/sdk/android/core/TwitterApiClient;->retrofit:Lrd/r;
...
.method private buildGson()Lja/f;
    .locals 3
    ...
    .line 4
    invoke-virtual {v0, v1, v2}, Lja/g;->c(Ljava/lang/reflect/Type;Ljava/lang/Object;)Lja/g;
...
.method private buildRetrofit(Lokhttp3/OkHttpClient;Lcom/twitter/sdk/android/core/internal/TwitterApi;)Lrd/r;
    .locals 1
    ...
    .line 2
    invoke-virtual {v0, p1}, Lrd/r$b;->f(Lokhttp3/OkHttpClient;)Lrd/r$b;
    ...
    invoke-virtual {p1, p2}, Lrd/r$b;->b(Ljava/lang/String;)Lrd/r$b;

    move-result-object p1

    .line 4
    invoke-direct {p0}, Lcom/twitter/sdk/android/core/TwitterApiClient;->buildGson()Lja/f;

    move-result-object p2

    invoke-static {p2}, Lsd/a;->b(Lja/f;)Lsd/a;
...
.method public getService(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lcom/twitter/sdk/android/core/TwitterApiClient;->retrofit:Lrd/r;

    invoke-virtual {v1, p1}, Lrd/r;->b(Ljava/lang/Class;)Ljava/lang/Object;
