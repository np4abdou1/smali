...
# virtual methods
.method public deserialize(Lja/l;Ljava/lang/reflect/Type;Lja/j;)Lcom/twitter/sdk/android/core/models/BindingValues;
    .locals 2
    ...
    .line 4
    :cond_0
    invoke-virtual {p1}, Lja/l;->b()Lja/n;

    move-result-object p1

    .line 5
    invoke-virtual {p1}, Lja/n;->k()Ljava/util/Set;
    ...
    invoke-virtual {v0}, Lja/l;->b()Lja/n;

    move-result-object v0

    .line 10
    invoke-virtual {p0, v0, p3}, Lcom/twitter/sdk/android/core/models/BindingValuesAdapter;->getValue(Lja/n;Lja/j;)Ljava/lang/Object;
...
.method public bridge synthetic deserialize(Lja/l;Ljava/lang/reflect/Type;Lja/j;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/gson/JsonParseException;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lcom/twitter/sdk/android/core/models/BindingValuesAdapter;->deserialize(Lja/l;Ljava/lang/reflect/Type;Lja/j;)Lcom/twitter/sdk/android/core/models/BindingValues;
...
.method public getValue(Lja/n;Lja/j;)Ljava/lang/Object;
    .locals 4

    const-string v0, "type"

    .line 1
    invoke-virtual {p1, v0}, Lja/n;->l(Ljava/lang/String;)Lja/l;
    ...
    .line 3
    :cond_0
    invoke-virtual {v0}, Lja/l;->d()Ljava/lang/String;
    ...
    invoke-interface {p2, p1, v0}, Lja/j;->a(Lja/l;Ljava/lang/reflect/Type;)Ljava/lang/Object;
...
.method public serialize(Lcom/twitter/sdk/android/core/models/BindingValues;Ljava/lang/reflect/Type;Lja/p;)Lja/l;
    .locals 0
...
.method public bridge synthetic serialize(Ljava/lang/Object;Ljava/lang/reflect/Type;Lja/p;)Lja/l;
    .locals 0

    .line 1
    check-cast p1, Lcom/twitter/sdk/android/core/models/BindingValues;

    invoke-virtual {p0, p1, p2, p3}, Lcom/twitter/sdk/android/core/models/BindingValuesAdapter;->serialize(Lcom/twitter/sdk/android/core/models/BindingValues;Ljava/lang/reflect/Type;Lja/p;)Lja/l;
