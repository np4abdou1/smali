...
.method public constructor <init>(Lcom/twitter/sdk/android/core/TwitterCore;Lcom/twitter/sdk/android/core/internal/TwitterApi;)V
    ...
    .line 2
    invoke-virtual {p0}, Lcom/twitter/sdk/android/core/internal/oauth/OAuthService;->getRetrofit()Lrd/r;

    move-result-object p1

    const-class p2, Lcom/twitter/sdk/android/core/internal/oauth/OAuth2Service$OAuth2Api;

    invoke-virtual {p1, p2}, Lrd/r;->b(Ljava/lang/Class;)Ljava/lang/Object;
...
.method public requestAppAuthToken(Lcom/twitter/sdk/android/core/Callback;)V
    ...
    invoke-interface {v0, v1, v2}, Lcom/twitter/sdk/android/core/internal/oauth/OAuth2Service$OAuth2Api;->getAppAuthToken(Ljava/lang/String;Ljava/lang/String;)Lrd/b;

    move-result-object v0

    .line 2
    invoke-interface {v0, p1}, Lrd/b;->c0(Lrd/d;)V
...
.method public requestGuestToken(Lcom/twitter/sdk/android/core/Callback;Lcom/twitter/sdk/android/core/internal/oauth/OAuth2Token;)V
    ...
    invoke-interface {v0, p2}, Lcom/twitter/sdk/android/core/internal/oauth/OAuth2Service$OAuth2Api;->getGuestToken(Ljava/lang/String;)Lrd/b;

    move-result-object p2

    invoke-interface {p2, p1}, Lrd/b;->c0(Lrd/d;)V
