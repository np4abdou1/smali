...
# direct methods
.method public constructor <init>(Ls3/c;Lv5/i;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lv5/i$k;->a:Ls3/c;

    iput-object p2, p0, Lv5/i$k;->b:Lv5/i;
...
.method public onResponse(Lrd/b;Lrd/q;)V
    ...
    .line 1
    iget-object p1, p0, Lv5/i$k;->a:Ls3/c;
    ...
    invoke-virtual {p1, p2}, Lw4/b;->o(Ljava/lang/String;)V

    .line 2
    iget-object p1, p0, Lv5/i$k;->b:Lv5/i;

    invoke-virtual {p1}, Lv5/i;->p0()Lv5/e;

    move-result-object p1

    iget-object p2, p0, Lv5/i$k;->a:Ls3/c;
    ...
    invoke-virtual {p1, p2}, Ln5/d;->onItemChanged(Ljava/lang/Object;)V
