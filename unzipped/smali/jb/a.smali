...
.method public static d(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILgb/b;)V
    .locals 8
    ...
    invoke-direct/range {v0 .. v6}, Lib/b;-><init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILgb/b;)V
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {v1, p0}, Ljb/f;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v1}, Ljb/f;->c()I

    move-result v0

    .line 3
    invoke-static {p0}, Ljb/a;->c(Ljava/io/Closeable;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
