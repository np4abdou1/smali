...
# static fields
.field public static final b:Lh5/k$a;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lh5/k$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lh5/k$a;-><init>(Ljc/g;)V

    sput-object v0, Lh5/k;->b:Lh5/k$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lh5/k;->a:Lz3/a;
...
.method public static final synthetic a(Lh5/k;Ljava/util/List;Lac/d;)Ljava/lang/Object;
    .locals 0
...
.method public b(Landroid/os/Bundle;Landroid/content/Context;)Lrc/y0;
    ...
    new-instance v4, Lh5/k$b;

    const/4 v0, 0x0

    invoke-direct {v4, p2, p1, p0, v0}, Lh5/k$b;-><init>(Landroid/content/Context;Landroid/os/Bundle;Lh5/k;Lac/d;)V
...
.method public c()Lz3/a;
    ...
    .line 1
    iget-object v0, p0, Lh5/k;->a:Lz3/a;
...
.method public bridge synthetic createNetworkClientRequest(Ljava/lang/Object;Landroid/content/Context;)Lrc/y0;
    ...
    invoke-virtual {p0, p1, p2}, Lh5/k;->b(Landroid/os/Bundle;Landroid/content/Context;)Lrc/y0;
...
.method public d(Landroid/os/Bundle;Landroid/content/Context;)Lrc/y0;
    ...
    new-instance v3, Lh5/k$c;

    const/4 p1, 0x0

    invoke-direct {v3, p0, p1}, Lh5/k$c;-><init>(Lh5/k;Lac/d;)V
...
.method public e(Landroid/os/Bundle;Landroid/content/Context;)V
    .locals 7
    ...
    new-instance v4, Lh5/k$d;

    const/4 v0, 0x0

    invoke-direct {v4, p2, p0, p1, v0}, Lh5/k$d;-><init>(Landroid/content/Context;Lh5/k;Landroid/os/Bundle;Lac/d;)V
...
.method public bridge synthetic getNetworkClient()Lio/wax911/support/custom/worker/SupportRequestClient;
    ...
    .line 1
    invoke-virtual {p0}, Lh5/k;->c()Lz3/a;
...
.method public bridge synthetic requestFromCache(Ljava/lang/Object;Landroid/content/Context;)Lrc/y0;
    ...
    invoke-virtual {p0, p1, p2}, Lh5/k;->d(Landroid/os/Bundle;Landroid/content/Context;)Lrc/y0;
...
.method public bridge synthetic requestFromNetwork(Ljava/lang/Object;Landroid/content/Context;)V
    .locals 0

    .line 1
    check-cast p1, Landroid/os/Bundle;

    invoke-virtual {p0, p1, p2}, Lh5/k;->e(Landroid/os/Bundle;Landroid/content/Context;)V
