...
.method public constructor <init>(Lcd/c0;)V
    ...
    .line 3
    invoke-interface {v0}, Lcd/h;->I()Ljava/lang/String;
    ...
    .line 6
    invoke-static {v0}, Lokhttp3/Cache;->readInt(Lcd/h;)I
    ...
    .line 30
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lcd/h;)Ljava/util/List;
    ...
    .line 38
    :goto_4
    invoke-interface {p1}, Lcd/c0;->close()V
...
.method private readCertificateList(Lcd/h;)Ljava/util/List;
    .locals 6
    ...
    .line 1
    invoke-static {p1}, Lokhttp3/Cache;->readInt(Lcd/h;)I
    ...
    .line 5
    invoke-interface {p1}, Lcd/h;->I()Ljava/lang/String;
    ...
    invoke-direct {v5}, Lcd/f;-><init>()V

    .line 7
    invoke-static {v4}, Lcd/i;->c(Ljava/lang/String;)Lcd/i;

    move-result-object v4

    invoke-virtual {v5, v4}, Lcd/f;->R0(Lcd/i;)Lcd/f;

    .line 8
    invoke-virtual {v5}, Lcd/f;->F0()Ljava/io/InputStream;
...
.method private writeCertList(Lcd/g;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lcd/g;->u0(J)Lcd/g;
    ...
    .line 2
    invoke-interface {v0, v1}, Lcd/g;->O(I)Lcd/g;
    ...
    .line 5
    invoke-static {v3}, Lcd/i;->q([B)Lcd/i;

    move-result-object v3

    invoke-virtual {v3}, Lcd/i;->a()Ljava/lang/String;

    move-result-object v3

    .line 6
    invoke-interface {p1, v3}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object v3

    .line 7
    invoke-interface {v3, v1}, Lcd/g;->O(I)Lcd/g;
    :try_end_0
...
.method public writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 1
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lcd/a0;
    ...
    invoke-interface {p1, v3, v4}, Lcd/g;->u0(J)Lcd/g;
    ...
    invoke-interface {p1, v5}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object v5

    .line 10
    invoke-interface {v5, v4}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    invoke-interface {v4, v5}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object v4

    .line 12
    invoke-interface {v4, v2}, Lcd/g;->O(I)Lcd/g;
    ...
    invoke-interface {p1, v5, v6}, Lcd/g;->u0(J)Lcd/g;
    ...
    .line 19
    invoke-interface {v3, v4}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    invoke-interface {v3, v5}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object v3

    .line 21
    invoke-interface {v3, v2}, Lcd/g;->O(I)Lcd/g;
    ...
    .line 24
    invoke-interface {v0, v5, v6}, Lcd/g;->u0(J)Lcd/g;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lcd/g;Ljava/util/List;)V
