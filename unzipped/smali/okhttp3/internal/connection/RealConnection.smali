...
.field private sink:Lcd/g;

.field private socket:Ljava/net/Socket;

.field private source:Lcd/h;
...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {p1}, Lcd/p;->m(Ljava/net/Socket;)Lcd/c0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcd/h;

    .line 11
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;

    invoke-static {p1}, Lcd/p;->i(Ljava/net/Socket;)Lcd/a0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcd/g;
    :try_end_1
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 31
    invoke-static {v1}, Lcd/p;->m(Ljava/net/Socket;)Lcd/c0;
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcd/g;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcd/h;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcd/h;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcd/g;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lcd/h;Lcd/g;)V

    .line 3
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcd/h;

    invoke-interface {v1}, Lcd/c0;->timeout()Lcd/d0;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lcd/d0;->timeout(JLjava/util/concurrent/TimeUnit;)Lcd/d0;

    .line 4
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcd/g;

    invoke-interface {v1}, Lcd/a0;->timeout()Lcd/d0;
    ...
    .line 11
    :cond_0
    invoke-virtual {v0, v4, v5}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lcd/c0;
    ...
    .line 12
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Lcd/c0;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 20
    :cond_4
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcd/h;

    invoke-interface {p1}, Lcd/h;->c()Lcd/f;

    move-result-object p1

    invoke-virtual {p1}, Lcd/f;->M()Z

    move-result p1

    if-eqz p1, :cond_5

    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcd/g;

    invoke-interface {p1}, Lcd/g;->c()Lcd/f;
...
.method private startHttp2(I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcd/h;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcd/g;

    invoke-virtual {v0, v1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lcd/h;Lcd/g;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 28
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:Lcd/h;

    .line 29
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lcd/g;
...
.method public isHealthy(Z)Z
    ...
    .line 6
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcd/h;

    invoke-interface {v2}, Lcd/h;->M()Z
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    .line 4
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcd/h;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcd/d0;->timeout(JLjava/util/concurrent/TimeUnit;)Lcd/d0;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcd/g;
    ...
    invoke-direct {p2, p1, p3, v0, v1}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lcd/h;Lcd/g;)V
...
.method public newWebSocketStreams(Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLcd/h;Lcd/g;Lokhttp3/internal/connection/StreamAllocation;)V
