...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    .line 11
    invoke-static {p1}, Lcd/i;->q([B)Lcd/i;

    move-result-object p1

    invoke-virtual {p1}, Lcd/i;->a()Ljava/lang/String;
...
.method private declared-synchronized send(Lcd/i;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILcd/i;)V
...
.method public checkResponse(Lokhttp3/Response;)V
    ...
    .line 8
    invoke-virtual {v0}, Lcd/i;->w()Lcd/i;
...
.method public declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILcd/i;J)V
...
.method public connect(Lokhttp3/OkHttpClient;)V
    ...
    .line 12
    invoke-interface {p1}, Lokhttp3/Call;->timeout()Lcd/d0;

    move-result-object p1

    invoke-virtual {p1}, Lcd/d0;->clearTimeout()Lcd/d0;
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lcd/g;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLcd/g;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lcd/h;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLcd/h;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Lcd/i;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lcd/i;)V
...
.method public declared-synchronized onReadPing(Lcd/i;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Lcd/i;)V
    .locals 0
...
.method public declared-synchronized pong(Lcd/i;)Z
    .locals 1
...
.method public send(Lcd/i;)Z
    ...
    .line 3
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lcd/i;I)Z
...
.method public writeOneFrame()Z
    ...
    .line 16
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lcd/i;)V
    ...
    iget-object v2, v2, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Lcd/i;
    ...
    .line 21
    invoke-virtual {v0, v3, v4, v5}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lcd/a0;
    ...
    .line 22
    invoke-interface {v0, v2}, Lcd/g;->B(Lcd/i;)Lcd/g;
    ...
    iget-object v4, v4, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lcd/i;

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILcd/i;)V
...
.method public writePingFrame()V
    ...
    :cond_2
    :try_start_1
    sget-object v1, Lcd/i;->i:Lcd/i;

    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lcd/i;)V
    :try_end_1
