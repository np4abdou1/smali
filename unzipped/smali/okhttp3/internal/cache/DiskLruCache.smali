...
.field public journalWriter:Lcd/g;
...
.method private newJournalWriter()Lcd/g;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lcd/a0;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;Lcd/a0;)V

    .line 3
    invoke-static {v1}, Lcd/p;->c(Lcd/a0;)Lcd/g;
...
.method private readJournal()V
    ...
    invoke-interface {v1, v2}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lcd/c0;
    ...
    .line 2
    :try_start_0
    invoke-interface {v1}, Lcd/h;->I()Ljava/lang/String;
    ...
    .line 16
    :cond_0
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Lcd/g;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcd/g;
    :try_end_2
...
.method public declared-synchronized close()V
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcd/g;
...
.method public declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 25
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcd/g;

    const-string v1, "CLEAN"

    invoke-interface {p1, v1}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object p1

    invoke-interface {p1, v3}, Lcd/g;->O(I)Lcd/g;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lcd/g;)V

    .line 28
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcd/g;

    invoke-interface {p1, v2}, Lcd/g;->O(I)Lcd/g;
    ...
    invoke-interface {p1, p2}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
...
.method public declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 11
    :cond_3
    iget-object p2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcd/g;

    const-string p3, "DIRTY"

    invoke-interface {p2, p3}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object p2

    const/16 p3, 0x20

    invoke-interface {p2, p3}, Lcd/g;->O(I)Lcd/g;

    move-result-object p2

    invoke-interface {p2, p1}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    invoke-interface {p2}, Lcd/g;->flush()V
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 9
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcd/g;

    const-string v2, "READ"

    invoke-interface {v1, v2}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {v1, v2}, Lcd/g;->O(I)Lcd/g;

    move-result-object v1

    invoke-interface {v1, p1}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object p1

    const/16 v1, 0xa

    invoke-interface {p1, v1}, Lcd/g;->O(I)Lcd/g;
...
.method public declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lcd/a0;

    move-result-object v0

    invoke-static {v0}, Lcd/p;->c(Lcd/a0;)Lcd/g;
    ...
    .line 4
    invoke-interface {v0, v1}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    invoke-interface {v0, v3, v4}, Lcd/g;->u0(J)Lcd/g;
    ...
    .line 8
    invoke-interface {v0, v2}, Lcd/g;->O(I)Lcd/g;
    ...
    .line 11
    invoke-interface {v0, v4}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object v4

    invoke-interface {v4, v5}, Lcd/g;->O(I)Lcd/g;

    .line 12
    iget-object v3, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    invoke-interface {v0, v3}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    .line 16
    invoke-virtual {v3, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lcd/g;)V
...
.method public removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v2}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
