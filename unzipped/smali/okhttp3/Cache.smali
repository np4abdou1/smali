...
.method public static key(Lokhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcd/i;->g(Ljava/lang/String;)Lcd/i;

    move-result-object p0

    invoke-virtual {p0}, Lcd/i;->p()Lcd/i;

    move-result-object p0

    invoke-virtual {p0}, Lcd/i;->m()Ljava/lang/String;
...
.method public static readInt(Lcd/h;)I
    .locals 5
    ...
    .line 1
    :try_start_0
    invoke-interface {p0}, Lcd/h;->Y()J

    move-result-wide v0

    .line 2
    invoke-interface {p0}, Lcd/h;->I()Ljava/lang/String;
...
.method public get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lcd/c0;

    move-result-object v3

    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(Lcd/c0;)V
    :try_end_1
