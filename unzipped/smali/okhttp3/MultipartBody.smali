...
# instance fields
.field private final boundary:Lcd/i;
...
.method public constructor <init>(Lcd/i;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundary:Lcd/i;
...
.method private writeOrCountBytes(Lcd/g;Z)J
    .locals 12
    .param p1    # Lcd/g;
    ...
    invoke-interface {p1, v8}, Lcd/g;->write([B)Lcd/g;

    .line 7
    iget-object v8, p0, Lokhttp3/MultipartBody;->boundary:Lcd/i;

    invoke-interface {p1, v8}, Lcd/g;->B(Lcd/i;)Lcd/g;
    ...
    invoke-interface {p1, v10}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    .line 11
    invoke-interface {v10, v11}, Lcd/g;->write([B)Lcd/g;
    ...
    invoke-interface {v10, v11}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    .line 15
    invoke-interface {p1, v8}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    invoke-interface {v8, v7}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;
    ...
    .line 17
    invoke-interface {v7, v8}, Lcd/g;->write([B)Lcd/g;
    ...
    .line 19
    invoke-interface {p1, v9}, Lcd/g;->t0(Ljava/lang/String;)Lcd/g;

    move-result-object v9

    .line 20
    invoke-interface {v9, v7, v8}, Lcd/g;->u0(J)Lcd/g;
    ...
    .line 21
    invoke-interface {v9, v10}, Lcd/g;->write([B)Lcd/g;
    ...
    invoke-interface {p1, v9}, Lcd/g;->write([B)Lcd/g;
    ...
    .line 24
    :cond_5
    invoke-virtual {v6, p1}, Lokhttp3/RequestBody;->writeTo(Lcd/g;)V
    ...
    invoke-interface {p1, v1}, Lcd/g;->write([B)Lcd/g;

    .line 27
    iget-object v2, p0, Lokhttp3/MultipartBody;->boundary:Lcd/i;

    invoke-interface {p1, v2}, Lcd/g;->B(Lcd/i;)Lcd/g;
...
.method public boundary()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundary:Lcd/i;

    invoke-virtual {v0}, Lcd/i;->C()Ljava/lang/String;
...
.method public contentLength()J
    ...
    .line 2
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lcd/g;Z)J
...
.method public writeTo(Lcd/g;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lcd/g;Z)J
